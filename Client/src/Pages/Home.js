...
const User = ({ role, handleUserInfo }) => (
  <>
    { role === 'general' ? <Link to="/client/mypage"><button className="tab change-tab-design">MY PAGE</button></Link> : <Link to="/business/mypage"><button className="tab change-tab-design">MY PAGE</button></Link> }
    <Link to="/">
      <button
